...
const projects: Project[] = [
  {
    ...
    description:
      "Proyek website modern dengan React dan Tailwind CSS. Termasuk fitur responsif dan animasi yang menarik.",
  ...
  },
  {
    ...
    description:
      "Website portfolio personal dengan desain minimalis dan animasi smooth.",
  ...
  {
    title: "Adventure Knight in Fairy Land",
    description:
      "is an adventure game. Playing as a brave knight, you must overcome obstacles, defeat monsters, and save the fairyland from a threatening dark force.",
    tags: ["Gdevelope"],
    link: "https://almahdi00.itch.io/adventure-knight-in-fairyland",
    github: "https://github.com/almahdi00/Pixel-Game",
    image: "img/Adventure knight.png",
  },
  {
    title: "Simple Game Store",
    description: "A simple Game Web Store that has many features.",
    tags: ["Laravel", "Tailwind"],
    link: "#",
    github: "https://github.com/almahdi00/Simple-Game-Store-Laravel",
    image: "img/game store.png",
  },
];
